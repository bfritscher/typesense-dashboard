...
const devApiProxyTarget = import.meta.env.DEV_API_PROXY_TARGET;
...
export default defineConfig((ctx) => {
  return {
    ...
    boot: ['instantsearch', 'darkmode', 'checkAutoLoginConfig'],
    ...
    build: {
      ...
      // publicPath: '/',
      publicPath:
        import.meta.env.PUBLIC_PATH ?? (ctx.dev ? '/' : '/typesense-dashboard'),
      defineEnv: {
